...
static const esp_gatts_attr_db_t gatt_db[HRS_IDX_NB] ={
    ...
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&primary_service_uuid, ESP_GATT_PERM_READ,
      sizeof(uint16_t), sizeof(GATTS_LED_SERVICE_UUID), (uint8_t *)&GATTS_LED_SERVICE_UUID}},
    ...
    [IDX_CHAR_VAL_A] =
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_SWITCH_CHAR_UUID, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
      GATTS_LED_CHAR_VAL_LEN_MAX, sizeof(char_value), (uint8_t *)char_value}},
    ...
    /* Characteristic Value */
    [IDX_CHAR_VAL_B]  =
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_TIMER_CHAR_UUID, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
      GATTS_LED_CHAR_VAL_LEN_MAX, sizeof(char_value), (uint8_t *)char_value}},
    ...
    /* Characteristic Value */
    [IDX_CHAR_VAL_C]  =
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_BRIGHTNESS_CHAR_UUID, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
      GATTS_LED_CHAR_VAL_LEN_MAX, sizeof(char_value), (uint8_t *)char_value}},
...
static void gatts_profile_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param){
    switch (event) {
        ...
        case ESP_GATTS_READ_EVT:
            ESP_LOGI(GATTS_LED_TAG, "ESP_GATTS_READ_EVT");
       	    break;
            ...
            if (!param->write.is_prep){
                ...
                if (led_control_handle_table[IDX_CHAR_CFG_A] == param->write.handle && param->write.len == 2){
                    ...
                    if (descr_value == 0x0001){
                        ...
                        esp_ble_gatts_send_indicate(gatts_if, param->write.conn_id, led_control_handle_table[IDX_CHAR_VAL_A],
        ...
        case ESP_GATTS_CREAT_ATTR_TAB_EVT:{
            if (param->add_attr_tab.status != ESP_GATT_OK){
                ...
                esp_ble_gatts_start_service(led_control_handle_table[IDX_SVC]);
            }
            break;
        }
